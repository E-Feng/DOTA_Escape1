...
--[[
  ...
  -Additionally, ensure that you have the escapetest_attachments.xml, escapetest_attachments.js, and escapetest_attachments.css files in your panorama content folder to use the GUI.
...
function Attachments:start()
  Convars:RegisterCommand( "attachment_configure", Dynamic_Wrap(Attachments, 'ActivateAttachmentSetup'), "Attachment Setup: attachment_configure <ADDON_NAME>  (e.g. attachment_configure escapetest)", FCVAR_CHEAT )
